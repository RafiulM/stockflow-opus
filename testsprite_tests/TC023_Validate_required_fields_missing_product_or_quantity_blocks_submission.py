...
async def run_test():
    ...
    try:
        ...
        # -> Clear the Email field (make it empty) and click 'Sign In' to verify that client-side required-field validation prevents submission and shows validation feedback.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/main/div/div/div[2]/form/div[2]/input').nth(0)
        ...
        frame = context.pages[-1]
        assert "/" in frame.url
        elem = frame.locator('xpath=/html/body/main/div/div/div[2]/form/div[2]/label').nth(0)
