...
async def run_test():
    ...
    try:
        ...
        # -> Enter provided credentials into the email and password fields and click the Sign In button to log in.
        ...
        frame = context.pages[-1]
        assert '/' in frame.url
        await expect(frame.locator('text=Transfer Stock').first).to_be_visible(timeout=3000)
