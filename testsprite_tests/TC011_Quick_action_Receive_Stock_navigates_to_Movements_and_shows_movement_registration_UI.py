...
async def run_test():
    ...
    try:
        ...
        # -> Click the Sign In button (element index 56) to attempt login/redirect, then wait for the page to update and check the URL contains '/'.
        frame = context.pages[-1]
        # Click element
        ...
        await expect(frame.locator('text=Register Movement').first).to_be_visible(timeout=3000)
