...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email field (index 3).
        ...
        await expect(frame.locator('xpath=//div[contains(@class,"utilization-indicator")]').first).to_be_visible(timeout=3000)
        await expect(frame.locator('text=Utilization').first).to_be_visible(timeout=3000)
