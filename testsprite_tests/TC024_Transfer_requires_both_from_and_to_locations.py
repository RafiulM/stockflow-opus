...
async def run_test():
    ...
    try:
        ...
        # -> Type 'raf@raf.com' into the email field and 'admin123' into the password field, then click Sign In
        ...
        await expect(frame.locator('text=To location').first).to_be_visible(timeout=3000)
