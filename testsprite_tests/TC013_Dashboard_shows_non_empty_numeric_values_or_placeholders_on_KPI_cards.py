...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email (index 3) and password (index 4) fields and click the Sign In button (index 7).
        ...
        await expect(frame.locator('text=Daily Movements').first).to_be_visible(timeout=3000)
