...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign up' link (element index 72) to open the signup page so the signup form fields can be verified.
        ...
        await expect(frame.locator("xpath=//label[normalize-space(.)='Name']").first).to_be_visible(timeout=3000)
        ...
        await expect(frame.locator("xpath=//button[normalize-space(.)='Sign Up']").first).to_be_visible(timeout=3000)
